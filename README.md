...
> **本地「我不是神」产品 / AI 维护入口**：见 [LOCAL.md](./docs/LOCAL.md) · [AGENTS.md](./AGENTS.md) · [docs/TESTING.md](./docs/TESTING.md) · [docs/AI_NATIVE.md](./docs/AI_NATIVE.md)（含省 token）

## News
- [2026-06] **TradingAgents v0.3.0** released with a verified data-access contract, an expanded provider registry (NVIDIA, Kimi, Groq, Mistral, Bedrock, and any OpenAI-compatible endpoint), FRED and Polymarket data vendors, a current-generation model catalog, and a CI gate. See [CHANGELOG.md](./docs/archive/CHANGELOG.md) for the full list.
...
Contributions are welcome: bug fixes, documentation, and feature ideas; past contributions are credited per release in [`CHANGELOG.md`](./docs/archive/CHANGELOG.md).
